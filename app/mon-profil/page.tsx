    ...
    <Layout>
      <style>{`
        ...
        .profil-input, .profil-select {
          padding: 11px 14px; border-radius: 10px; border: 1.5px solid #e8e2d8;
        ...
        .tmi-btn {
          padding: 8px 16px; border-radius: 8px; border: 1.5px solid #e8e2d8;
          font-family: 'DM Sans', sans-serif; font-size: 13px; font-weight: 500;
          cursor: pointer; transition: all 0.15s; background: #faf8f5; color: #1a1210;
        }
      ...
      <div className="profil-wrap">
        ...
        {success && <div className="profil-success">✅ Profil sauvegardé !</div>}
        ...
        <form onSubmit={handleSave}>
          ...
          <div className="profil-section">
            <div className="profil-section-title">Fiscalité</div>
              ...
              <div className="tmi-options">
                {TMI_OPTIONS.map(t => (
                  <button key={t} type="button"
                    className={`tmi-btn ${profile?.tmi === t ? 'active' : ''}`}
            ...
            <div className="profil-field">
              <label className="profil-label">Régime fiscal préféré</label>
          ...
          <div className="profil-section">
            ...
            <div className="profil-grid">
              <div className="profil-field">
                <label className="profil-label">Apport (€)</label>
              ...
              <div className="profil-field">
                <label className="profil-label">Taux crédit (%)</label>
                <input className="profil-input" type="number" step="0.1" value={profile?.taux_credit || ''} onChange={e => update('taux_credit', Number(e.target.value))} />
              </div>
              <div className="profil-field">
                <label className="profil-label">Durée (ans)</label>
