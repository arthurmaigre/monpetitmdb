...
export default function GuideArticleClient({ article, related }: { article: Article; related: RelatedArticle[] }) {
      ...
      <div className="guide-layout">
        ...
        <main className="guide-main">
          ...
          <div className="guide-meta">
            <div className="guide-avatar">{(article.author || 'R')[0]}</div>
            <div>
              <div className="guide-author-name">{article.author || 'La r\u00e9daction Mon Petit MDB'}</div>
          ...
          {article.cover_url && (
            <img
              ...
              alt={article.title}
              style={{ width: '100%', height: 'auto', borderRadius: '16px', marginBottom: '32px', maxHeight: '400px', objectFit: 'cover' }}
            />
          )}
          ...
          <div className="guide-share">
            ...
            <button
              className={`guide-share-btn ${copied ? 'guide-share-copied' : ''}`}
              onClick={() => {
            ...
            <div className="guide-related">
              ...
              <div className="guide-related-grid">
                {related.map((r) => {
                  ...
                  return (
                    <a key={r.slug} href={`/guide/${r.slug}`} className="guide-related-card">
                      {r.cover_url && <img src={r.cover_url} alt="" />}
                      <div className="guide-related-card-body">
                        {r.category && (
                          <span className="guide-related-card-cat" style={{ background: cs.bg, color: cs.color }}>{r.category}</span>
                        )}
          ...
          <div className="guide-footer">
            <a href="/guide">{"Voir tous les guides \u2192"}</a>
          </div>
        </main>
      </div>
    </Layout>
